import{j as l}from"../vendor/vendor-motion-siEo8VfX.js";import{F as t,a9 as c,cl as v,I as g,o as h,m as n,j as f,r as j}from"./index-C275yc7e.js";import{G as b}from"./Grid-C06UCg1E.js";import{r as p}from"../vendor/vendor-emotion-B6qZrIr4.js";const m=p.memo(({className:a,style:o,value:r="--"})=>l.jsxs(t,{horizontal:!0,align:"center",className:a,gap:4,style:{overflow:"hidden",position:"relative",...o},children:[l.jsx(c,{ellipsis:!0,style:{color:"inherit",fontFamily:"inherit",fontSize:"inherit",margin:0,overflow:"hidden",width:"100%"},children:r||"--"}),l.jsx(v,{content:r||"--",size:"small"})]})),d=f(({css:a,cssVar:o})=>({bordered:a`
      overflow: hidden;
