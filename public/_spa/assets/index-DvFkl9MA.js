import{j as t}from"../vendor/vendor-motion-siEo8VfX.js";import{a4 as $,F as g,a9 as M,j as S,k as C,bG as T,aV as L,bY as B,B as w}from"./index-C275yc7e.js";import{M as N}from"./Modal-DH7Lw-FF.js";import{r as i}from"../vendor/vendor-emotion-B6qZrIr4.js";import{S as R}from"./SearchBar-B03_FcLd.js";import{S as j}from"./index-DMKxTJGG.js";import{q as F}from"./index-CKzyhCAc.js";import{A as k}from"./AgentSelectionEmpty-BWhYDmfl.js";import{A as z}from"./index-B1FRBCSR.js";import{C as E}from"./index-C_TRf6KE.js";import{u as q}from"./index-8Ahw8gye.js";import{c as D}from"./react-BIftPCcY.js";import{bn as H}from"../vendor/vendor-icons-CwKawJ1k.js";const f=D((e,n)=>({clearSelection:()=>{e({selectedAgentIds:[]})},isSelected:o=>n().selectedAgentIds.includes(o),removeAgent:o=>{e(s=>({selectedAgentIds:s.selectedAgentIds.filter(l=>l!==o)}))},selectedAgentIds:[],setSelectedAgents:o=>{e({selectedAgentIds:o})},toggleAgent:o=>{e(s=>s.selectedAgentIds.includes(o)?{selectedAgentIds:s.selectedAgentIds.filter(r=>r!==o)}:{selectedAgentIds:[...s.selectedAgentIds,o]})}})),y=S(({css:e,cssVar:n})=>({item:e`
    cursor: pointer;
  ...
  `})),P=i.memo(({agents:e,isLoading:n})=>{const{t:o}=C(["chat","common"]),[s,l]=i.useState(""),r=i.useMemo(()=>o("defaultSession",{ns:"common"}),[o]),c=i.useCallback(d=>{l(d.target.value)},[]),m=i.useMemo(()=>{if(!s.trim())return e;const d=s.toLowerCase();return e.filter(u=>{const x=u.title||"",h=u.description||"";return x.toLowerCase().includes(d)||h.toLowerCase().includes(d)})},[e,s]);return t.jsxs(g,{className:G.container,gap:12,children:[t.jsx(R,{allowClear:!0,placeholder:o("memberSelection.searchAgents"),value:s,variant:"filled",onChange:c}),t.jsx(g,{flex:1,style:{minHeight:0},children:n?t.jsxs(g,{gap:8,padding:8,children:[t.jsx(j,{active:!0,paragraph:{rows:1},title:!1}),t.jsx(j,{active:!0,paragraph:{rows:1},title:!1}),t.jsx(j,{active:!0,paragraph:{rows:1},title:!1})]}):m.length===0?t.jsx(k,{search:!!s,variant:s?"empty":"noAvailable"}):t.jsx(F,{style:{flex:1},totalCount:m.length,itemContent:d=>{const u=m[d];return t.jsx(I,{showCheckbox:!0,agent:u,defaultTitle:r},u.id)}})})]})}),b=S(({css:e,cssVar:n})=>({container:e`
    overflow-y: auto;
    flex: 1;
