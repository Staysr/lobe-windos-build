import{cc as m,j as i,r as n,c8 as b,h as W,F as g,I as M,m as N,cf as H}from"./index-C275yc7e.js";import{r as R}from"../vendor/vendor-emotion-B6qZrIr4.js";import{j as l}from"../vendor/vendor-motion-siEo8VfX.js";import{g as w}from"../vendor/vendor-es-toolkit-CFMjQStz.js";const o="ant",d=i(({css:e,cssVar:t})=>({borderless:e`
    gap: 48px;
  ...
  `})),A=m(d.root,{defaultVariants:{variant:"borderless"},variants:{variant:{filled:d.filled,outlined:d.outlined,borderless:d.borderless}}}),s=i(({cx:e,css:t,cssVar:r})=>({borderless:e(b.variantBorderlessWithoutHover,t`
        padding-inline: 0;
  ...
  `,title:e`
    font-weight: 500;
    line-height: 1;
  `})),D=R.memo(({className:e,icon:t,title:r,children:$,extra:h,variant:c="borderless",defaultActive:k=!0,collapsible:v,active:y,keyValue:u="group",onCollapse:B,desc:S,...j})=>{const{mobile:C}=W(),a=x,f=c==="borderless",F=w(v)?!f:v,G=l.jsxs(g,{horizontal:!0,className:N(L({variant:c}),a.titleMobile),gap:8,children:[t&&l.jsx(M,{icon:t}),r]});return C?l.jsxs(g,{className:e,children:[l.jsxs(g,{horizontal:!0,className:a.mobileGroupHeader,justify:"space-between",children:[G,h]}),l.jsx("div",{className:a.mobileGroupBody,children:$})]}):l.jsx(H,{activeKey:w(y)?void 0:y?[u]:[],className:e,collapsible:F,defaultActiveKey:k?[u]:void 0,variant:c,classNames:{header:f?a.titleBorderless:void 0,title:f?a.titleBorderless:void 0},items:[{children:$,desc:S,extra:h,icon:t,key:u,label:r}],onChange:z=>B?.(z.length>0),...j})});D.displayName="FormGroup";export{D as F,O as a,s as f,Q as i,T as s,U as t,A as v};
