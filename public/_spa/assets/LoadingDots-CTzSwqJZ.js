import{f as m,j as y}from"./index-Rjxk4g_I.js";import{r as p}from"../vendor/vendor-emotion-DdM-9MtU.js";import{j as t}from"../vendor/vendor-motion-BIhyHZ0p.js";const i=m(({css:e,cssVar:n})=>{const a="var(--loading-dots-size, 8px)",s="var(--loading-dots-color, var(--ant-color-primary))";return{container:e`
      display: flex;
      flex-direction: row;
      gap: 6px;
      align-items: center;
