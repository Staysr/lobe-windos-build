import{j as t}from"../vendor/vendor-motion-DRC1LdIk.js";import{k as E,h7 as Te,m as R,a3 as D,a9 as I,a8 as h,bT as K,F as u,o as y,cf as ke,B as re,j as ze,cR as ae}from"./index-BBAuCJqA.js";import{A as O}from"./index-GNbd6Ibo.js";import{C as le}from"./index-Cv8Q6aFu.js";import{E as B}from"./Empty-BmpfRZff.js";import{M as we}from"./Modal-DupZSReQ.js";import{L as ne}from"./index-cRHAhCuv.js";import{S as $e}from"./SearchBar-CBEWBUiS.js";import{r as s}from"../vendor/vendor-emotion-D2wYcXAj.js";import{G as Ae}from"./index-D4zDEdf6.js";import{M as Re}from"./index-CUGcbQv_.js";import{u as We}from"./useEnabledChatModels-Cp65Cl_d.js";import{u as Le}from"./index-CyMfM3Iz.js";import{o as Ne}from"../vendor/vendor-es-toolkit-O0KSByiM.js";import{a4 as W}from"../vendor/vendor-icons-C6hg4LnF.js";const Pe=()=>{const{t:r}=E("welcome");return["brainstorm","analysis","writing","planning","product","game"].map(m=>({description:r(`guide.groupTemplates.${m}.description`),id:m,members:r(`guide.groupTemplates.${m}.members`,{returnObjects:!0}),title:r(`guide.groupTemplates.${m}.title`)}))},Be=s.memo(({template:r,isSelected:n,onToggle:m,styles:p,cx:k})=>{const{t:a}=E("chat");return t.jsx("div",{className:k(p.listItem),onClick:()=>m(r.id),children:t.jsxs(u,{horizontal:!0,align:"center",gap:12,width:"100%",children:[t.jsx(le,{checked:n,onChange:()=>m(r.id),onClick:ae}),t.jsx(Ae,{size:40,avatars:r.members.filter(l=>l!=null).map(l=>({avatar:l.avatar||D,background:l.backgroundColor||void 0}))}),t.jsxs(u,{flex:1,gap:2,children:[t.jsx(h,{className:p.title,children:r.title}),t.jsx(h,{ellipsis:!0,className:p.description,children:r.description}),t.jsxs(u,{horizontal:!0,align:"center",gap:4,children:[t.jsx(W,{size:11,style:{color:"#999"}}),t.jsx(h,{style:{fontSize:11},type:"secondary",children:a("groupWizard.memberCount",{count:r.members.filter(l=>l!=null).length})})]})]})]})})}),De=s.memo(({agent:r,isSelected:n,onToggle:m,styles:p,cx:k})=>{const{t:a}=E(["chat","common"]),l=r.config?.id,S=r.meta?.title||a("defaultSession",{ns:"common"}),C=r.meta?.description||"",x=r.meta?.avatar||D,z=r.meta?.backgroundColor;return l?t.jsx("div",{className:k(p.listItem),onClick:()=>m(l),children:t.jsxs(u,{horizontal:!0,align:"center",gap:12,width:"100%",children:[t.jsx(le,{checked:n,onChange:()=>m(l),onClick:ae}),t.jsx(O,{avatar:x,background:z,size:40}),t.jsxs(u,{flex:1,gap:2,style:{minWidth:0},children:[t.jsx(h,{className:p.title,children:S}),C&&t.jsx(h,{ellipsis:!0,className:p.description,children:C})]})]})}):null}),g=ze(({css:r,cssVar:n})=>({container:r`
    display: flex;
    flex-direction: row;
