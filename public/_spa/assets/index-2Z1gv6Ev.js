import{j as o}from"../vendor/vendor-motion-siEo8VfX.js";import{G as C}from"./Grid-C06UCg1E.js";import{k as b,F as s,aa as g,T as d,I as h,o as q,j as T,f as G,cQ as L,cR as Y,n as M,L as R,a9 as y}from"./index-C275yc7e.js";import{r as p}from"../vendor/vendor-emotion-B6qZrIr4.js";import{A as Q}from"./AssistantEmpty-BMBGY4i6.js";import{A as U}from"./index-B1FRBCSR.js";import{q as _}from"./base-AbuBx_QK.js";import{P as J}from"./PublishedTime-DQkvB9Yf.js";import{u as K}from"./useQuery-CHrqOYEw.js";import{a as v}from"./format-CzTD0Usd.js";import{b8 as H,b9 as O,ba as W,ab as X}from"../vendor/vendor-icons-CwKawJ1k.js";import{I as Z}from"./index-DBMwQ_S4.js";const k=T(({css:e,cssVar:t})=>({token:e`
      border-radius: 4px;
    ...
    `})),oo=p.memo(({createdAt:e,updatedAt:t,author:r,avatar:n,title:i,description:a,category:$,identifier:x,tokenUsage:w,pluginCount:z,knowledgeCount:A,forkCount:B,backgroundColor:E,userName:l,type:I})=>{const m=G(),{source:D}=K(),u=I==="agent-group",S=u?"/community/group_agent":"/community/agent",f=_.stringifyUrl({query:{source:D},url:L(S,x)},{skipNull:!0}),{t:j}=b("discover"),F=p.useCallback(P=>{P.stopPropagation(),l&&m(`/community/user/${l}`)},[l,m]),N=p.useCallback(()=>{Y.reportAgentEvent({event:"click",identifier:x,source:location.pathname}).catch(()=>{}),m(f)},[x,f,m]);return o.jsxs(M,{clickable:!0,"data-testid":"assistant-item",height:"100%",variant:"outlined",width:"100%",style:{overflow:"hidden",position:"relative"},onClick:N,children:[u&&o.jsx(d,{color:"info",style:{position:"absolute",right:12,top:12,zIndex:1},children:j("groupAgents.tag",{defaultValue:"群组"})}),o.jsx(s,{horizontal:!0,align:"flex-start",gap:16,justify:"space-between",padding:16,style:{paddingRight:u?80:16},width:"100%",children:o.jsxs(s,{horizontal:!0,gap:12,title:x,style:{overflow:"hidden"},children:[o.jsx(U,{avatar:n,background:E||"transparent",shape:"square",size:40,style:{flex:"none"}}),o.jsxs(s,{flex:1,gap:2,style:{overflow:"hidden"},children:[o.jsx(s,{horizontal:!0,align:"center",flex:1,gap:8,style:{overflow:"hidden"},children:o.jsx(R,{style:{color:"inherit",overflow:"hidden"},to:f,children:o.jsx(y,{ellipsis:!0,as:"h2",className:c.title,children:i})})}),r&&o.jsx("div",{className:l?c.author:void 0,style:l?void 0:{color:"inherit"},onClick:l?F:void 0,children:r})]})]})}),o.jsxs(s,{flex:1,gap:12,paddingInline:16,children:[o.jsx(y,{as:"p",className:c.desc,ellipsis:{rows:3},children:a}),o.jsx(V,{forkCount:B,knowledgeCount:A,pluginCount:z,tokenUsage:w})]}),o.jsx(s,{horizontal:!0,align:"center",className:c.footer,justify:"space-between",padding:16,children:o.jsxs(s,{horizontal:!0,align:"center",className:c.secondaryDesc,justify:"space-between",children:[o.jsxs(s,{horizontal:!0,align:"center",gap:4,children:[o.jsx(h,{icon:X,size:14}),o.jsx(J,{className:c.secondaryDesc,date:t||e,template:"MMM DD, YYYY"})]}),j(`category.assistant.${$}`)]})})]})}),mo=p.memo(({data:e=[],rows:t=3})=>e.length===0?o.jsx(Q,{}):o.jsx(C,{rows:t,width:"100%",children:e.map((r,n)=>o.jsx(oo,{...r},n))}));export{mo as A,V as T};
