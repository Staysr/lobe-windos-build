import{j as e}from"../vendor/vendor-motion-BIhyHZ0p.js";import{L as z,F as o,I as v,f as F,g as B,T as L,B as $,ax as q,c as M}from"./index-Rjxk4g_I.js";import{E as P}from"./Empty--CBOQBIK.js";import{r as b}from"../vendor/vendor-emotion-DdM-9MtU.js";import{N as U}from"./index-BDLVXAkD.js";import{u as N}from"./store-RxaoeO5N.js";import{S as H}from"./StatusBadge-CEDTQw3B.js";import{ae as W,ac as Q,bD as G,bE as _,U as J,bq as K,bF as X,bG as O,t as Y,bH as Z,bI as V,E as ee,am as te,bJ as re,bK as ae,aa as ne,bL as oe,bM as se,bN as ie,bO as le,a_ as A}from"../vendor/vendor-icons-B5XxavR9.js";import{I as E}from"./Input-D93QuJ5O.js";import{T as ce}from"./TextArea-Oy32KVXb.js";import{M as de}from"./Modal-DwD3upc5.js";import{S as pe}from"./Select-BdPOlCrx.js";import{F as k}from"./index-DiS6uszb.js";import"../i18n/i18n-zh-CN-CO_PhvK1.js";import"../i18n/i18n-en-US-B1hbRPog.js";import"../vendor/vendor-es-toolkit-DEdCfXFH.js";import"./providerConfig-DjTKVWb5.js";import"./Block-Bz_9WVCI.js";import"./style-DYgTWtFE.js";import"./index-D2z-csWU.js";import"./index-Co4R0xG7.js";import"./Input-TQ_a30Wx.js";import"./index-DekwUdRV.js";import"./EyeOutlined-CbF7guFw.js";import"./TextArea-D1PECi1L.js";import"./Drawer-CwjeViBh.js";import"./useForm-CAb3TyrQ.js";import"./row-MBlO-RSB.js";import"./index-E-558r2I.js";const h=F(({css:t,cssVar:r})=>({meta:t`
    font-size: 11px;
  ...
  `})),Qe=b.memo(()=>{const{t}=B("eval"),[r,a]=b.useState(!1),d=N(n=>n.benchmarkList),u=N(n=>n.useFetchBenchmarks),{isLoading:i}=u();return e.jsxs(o,{className:T.container,gap:32,height:"100%",width:"100%",children:[e.jsxs(o,{horizontal:!0,align:"center",justify:"space-between",children:[e.jsxs(o,{gap:4,children:[e.jsx("h1",{className:T.title,children:t("overview.title")}),e.jsx("p",{className:T.subtitle,children:t("overview.subtitle")})]}),d.length>0&&e.jsx($,{icon:A,type:"primary",onClick:()=>a(!0),children:t("overview.createBenchmark")})]}),i?e.jsx(o,{align:"center",flex:1,justify:"center",children:e.jsx(U,{size:64})}):d.length===0?e.jsx(o,{align:"center",flex:1,justify:"center",children:e.jsx(P,{description:t("benchmark.empty"),icon:O,children:e.jsx($,{icon:A,style:{marginTop:16},type:"primary",onClick:()=>a(!0),children:t("overview.createBenchmark")})})}):e.jsx("div",{style:{display:"grid",gap:20,gridTemplateColumns:"repeat(auto-fill, minmax(480px, 1fr))"},children:d.map(n=>e.jsx(xe,{bestScore:n.bestScore,datasetCount:n.datasetCount,description:n.description,id:n.id,name:n.name,recentRuns:n.recentRuns,runCount:n.runCount,source:n.source,tags:n.tags,testCaseCount:n.testCaseCount},n.id))}),e.jsx(ge,{open:r,onCancel:()=>a(!1)})]})});export{Qe as default};
