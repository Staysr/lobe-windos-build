import{ad as m,f as r,r as n,ae as b,e as M,F as g,I as N,j as H,bi as R}from"./index-Rjxk4g_I.js";import{r as L}from"../vendor/vendor-emotion-DdM-9MtU.js";import{j as l}from"../vendor/vendor-motion-BIhyHZ0p.js";import{h as k}from"../vendor/vendor-es-toolkit-DEdCfXFH.js";const o="ant",s=r(({css:e,cssVar:t})=>({borderless:e`
    gap: 48px;
  ...
  `,title:e`
    font-weight: 500;
    line-height: 1;
  `})),B=L.memo(({className:e,icon:t,title:i,children:v,extra:h,variant:c="borderless",defaultActive:$=!0,collapsible:y,active:w,keyValue:u="group",onCollapse:S,desc:j,...C})=>{const{mobile:F}=M(),a=x,f=c==="borderless",G=k(y)?!f:y,z=l.jsxs(g,{horizontal:!0,className:H(_({variant:c}),a.titleMobile),gap:8,children:[t&&l.jsx(N,{icon:t}),i]});return F?l.jsxs(g,{className:e,children:[l.jsxs(g,{horizontal:!0,className:a.mobileGroupHeader,justify:"space-between",children:[z,h]}),l.jsx("div",{className:a.mobileGroupBody,children:v})]}):l.jsx(R,{activeKey:k(w)?void 0:w?[u]:[],className:e,collapsible:G,defaultActiveKey:$?[u]:void 0,variant:c,classNames:{header:f?a.titleBorderless:void 0,title:f?a.titleBorderless:void 0},items:[{children:v,desc:j,extra:h,icon:t,key:u,label:i}],onChange:W=>S?.(W.length>0),...C})});B.displayName="FormGroup";var U=B;export{U as F,A as a,d as f,O as i,Q as s,T as t,q as v};
