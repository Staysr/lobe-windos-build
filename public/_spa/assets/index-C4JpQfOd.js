import{j as a,c as le}from"../vendor/vendor-motion-DRC1LdIk.js";import{k as Z,ec as re,aY as Sn,by as An,bt as $e,iF as Qt,L as rt,F as T,T as Ne,I as H,W as ke,au as wn,a_ as Tn,o as E,j as te,af as Cn,m as L,ax as On,aS as lt,bX as Rn,aT as ct,B as Pn,f as _n,bw as bt,cD as $n,aX as Nn,aG as In}from"./index-BBAuCJqA.js";import{r as b,R as C,g as Jt}from"../vendor/vendor-emotion-D2wYcXAj.js";import{a as En,u as G}from"./store-OpdFyaYT.js";import{C as jt}from"./index-Ds95mZpO.js";import{T as ge}from"./index-7EB5obVF.js";import{F as Yt}from"./Table-OPobPAn9.js";import{B as ne}from"./index-PBycsoCz.js";import"../vendor/vendor-es-toolkit-O0KSByiM.js";import{e as Ie,g as Ee}from"./format-BRCSVQG4.js";import"./providerConfig-DLbrlvJC.js";import{bN as Ln,cV as Xt,t as Le,o as ut,bz as dt,dP as pt,ab as Vt,bo as Dn,cm as zn,P as Bn,cM as Fn,bq as Mn,da as Kn,b3 as Wn,_ as Hn,ae as Un,O as qn,bO as Gn}from"../vendor/vendor-icons-C6hg4LnF.js";import{S as Zn}from"./index-BY_9ea5Y.js";import{f as B,r as en,a as Qn,b as Jn,i as xe,T as ft,p as ae,L as V,g as tn,c as mt,d as nn,D as Yn,C as Xn,e as Te,h as je,S as Vn,A as er,j as tr,k as kt,l as nr,m as Se,n as rr,u as ar,G as ir,o as Ke,q as or,s as sr,t as lr,v as Fe,w as St,x as cr,y as ur,z as dr,B as pr,E as fr,F as mr,H as hr,I as gr,R as xr,J as vr,K as yr,N as br,M as jr}from"./index-CmYMclQC.js";import{r as rn}from"./_baseAssignValue-BEuvsmyU.js";import{A as kr}from"./index-GNbd6Ibo.js";import{M as Sr}from"./Markdown-C61aHzBp.js";import{R as Ar}from"./index-C2vqcPND.js";import{S as wr}from"./StatusBadge-DoCOj9Xa.js";import{C as We}from"./index-DAQnES1Z.js";import{a as At}from"./utils-DdCRt2d3.js";import{r as et}from"./selectors-D8FoU16Z.js";import{P as Tr}from"./progress-DdbsdCjT.js";import"../i18n/i18n-zh-CN-CErfCpws.js";import"../i18n/i18n-en-US-Dpq1-67h.js";import"./useBubbleLock-BPwjL_yj.js";import"./index-Bz4sOK-X.js";import"./useForm-BVlaNNzA.js";import"./scrollTo-1DYJHy84.js";import"./Pagination-CpmX6Kfs.js";import"./index-D_OrzpAP.js";import"./debounce-BRJQYKae.js";import"./tiny-invariant-CopsF_GD.js";import"./step-B6EOmCqb.js";import"./index-Chjiymov.js";import"./band-CquvqAHh.js";import"./init-Dmth1JHB.js";import"./ordinal-DILIJJjt.js";import"./linear-BkEJkjA2.js";import"./defaultLocale-DX6XiGOO.js";import"./time-DAeG9hya.js";import"./index-C8CgY4-I.js";import"./index-D_NDLVtF.js";import"./index-ByHC1s9V.js";import"./Snippet-BgrCzHU6.js";import"./Spotlight-BfNArZet.js";import"./useTranslation-8Gs39hO6.js";import"./image-nnCaCTxV.js";import"./index-BcsJv02u.js";import"./index-C0yP_FPJ.js";import"./index-MaA-KmeU.js";import"./ScrollShadow-CojQ7ODV.js";import"./index-B66PVBgD.js";import"./AccordionItem-BFTyuvm7.js";import"./index-DwHjYE4k.js";import"./row-ClDdlNJa.js";import"./index-BcDKp4gU.js";const Cr=b.memo(({status:e})=>{const{t}=Z("eval");return e==="error"?a.jsx(ne,{color:"orange",text:t("table.filter.error")}):e==="timeout"?a.jsx(ne,{color:"orange",text:t("run.status.timeout")}):a.jsx(Qt,{children:e})}),Or=b.memo(({open:e,onClose:t,onConfirm:r,runId:n})=>{const{t:i}=Z("eval"),{t:o}=Z("common"),[s,c]=b.useState([]),[l,u]=b.useState(!1),[p,y]=b.useState(!1),[j,A]=b.useState([]),[k,f]=b.useState(10);b.useEffect(()=>{e&&(A([]),u(!0),En.getResumableCases(n).then(v=>{c(v),A(v.filter(d=>d.canResume).map(d=>d.testCaseId))}).finally(()=>u(!1)))},[e,n]);const S=b.useMemo(()=>s.filter(v=>v.canResume),[s]),w=j.length===S.length&&S.length>0,g=j.length>0&&j.length<S.length,O=b.useCallback(v=>{A(v?S.map(d=>d.testCaseId):[])},[S]),P=b.useCallback((v,d)=>{A(m=>d?[...m,v]:m.filter(x=>x!==v))},[]),N=b.useMemo(()=>[{key:"select",render:(v,d)=>a.jsx(re,{title:d.canResume?void 0:d.reason,children:a.jsx(jt,{checked:j.includes(d.testCaseId),disabled:!d.canResume,onChange:m=>P(d.testCaseId,m.target.checked)})}),title:a.jsx(jt,{checked:w,disabled:S.length===0,indeterminate:g,onChange:v=>O(v.target.checked)}),width:48},{key:"index",render:(v,d)=>a.jsx("span",{style:{color:"var(--ant-color-text-tertiary)",fontFamily:"monospace",fontSize:12},children:d.sortOrder??"-"}),title:"#",width:48},{key:"input",render:(v,d)=>a.jsx(ge.Paragraph,{ellipsis:{expandable:!0,rows:2,symbol:"..."},style:{margin:0},children:d.input}),title:i("table.columns.input")},{key:"status",render:(v,d)=>a.jsx(re,{title:d.canResume?void 0:d.reason,children:a.jsx(Cr,{status:d.resumeStatus})}),title:i("table.columns.status"),width:110}],[i,j,w,g,S,P,O]),I=async()=>{if(j.length!==0){y(!0);try{await r(s.filter(v=>j.includes(v.testCaseId)).map(v=>({testCaseId:v.testCaseId,threadId:v.threadId}))),t()}finally{y(!1)}}};return a.jsx(Sn,{destroyOnHidden:!0,open:e,title:i("run.actions.batchResume.modal.title"),width:700,footer:[a.jsx($e,{onClick:t,children:o("cancel")},"cancel"),a.jsxs($e,{disabled:j.length===0,loading:p,type:"primary",onClick:I,children:[i("run.actions.batchResume.modal.confirm")," (",j.length,")"]},"confirm")],onCancel:t,children:l?a.jsx(An,{active:!0,paragraph:{rows:4}}):a.jsx(Yt,{columns:N,dataSource:s,rowKey:"testCaseId",scroll:{y:400},size:"small",style:{minHeight:300},pagination:{pageSize:k,showSizeChanger:!0,size:"small",onShowSizeChange:(v,d)=>f(d)}})})}),wt=new Set(["error","timeout"]),an=(e,t)=>{if(t<=1)return wt.has(e.status??"")?{resumeStatus:e.status}:void 0;const r=e.evalResult?.threads?.find(n=>wt.has(n.status??""));if(r?.status)return{resumeStatus:r.status,threadId:r.threadId}},W=te(({css:e,cssVar:t})=>({caseLink:e`
    color: inherit;
