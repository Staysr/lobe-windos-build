import{j as e}from"../vendor/vendor-motion-DRC1LdIk.js";import{F as s,o as n,n as z,C as D,I,a8 as P,m as R,j as A}from"./index-BBAuCJqA.js";import{S as f}from"./index-BY_9ea5Y.js";import{r as x}from"../vendor/vendor-emotion-D2wYcXAj.js";import{C as B}from"./ContextMenuTrigger-BiiimvcQ.js";import{N as E}from"./index-vMrk6En8.js";import"./providerConfig-DLbrlvJC.js";const _=x.memo(({padding:t=6,height:i=36,style:l,avatarSize:o=28,...a})=>e.jsxs(s,{horizontal:!0,align:"center",flex:1,gap:8,height:i,padding:t,style:l,...a,children:[e.jsx(f.Button,{size:"small",style:{borderRadius:n.borderRadius,height:o,maxHeight:o,maxWidth:o,minWidth:o}}),e.jsx(s,{flex:1,height:16,children:e.jsx(f.Button,{active:!0,block:!0,size:"small",style:{borderRadius:n.borderRadius,height:16,margin:0,maxHeight:16,opacity:.5,padding:0}})})]})),q=x.memo(({rows:t=3,...i})=>e.jsx(s,{gap:2,...i,children:Array.from({length:t}).map((l,o)=>e.jsx(_,{},o))})),L=t=>t.metaKey||t.ctrlKey,c="nav-item-actions",O=A(({css:t})=>({container:t`
    user-select: none;
    overflow: hidden;
    min-width: 32px;
