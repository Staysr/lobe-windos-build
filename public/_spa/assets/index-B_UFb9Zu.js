import{iG as oe,s as B,u as R,iH as ie,iI as se,j as k,k as w,cg as le,n as ce,m as b,a8 as A,i as C,gg as de,F as g,W as H,U as Z,V as ue,c as he,ce as pe,$ as me,gW as fe,bx as L,h6 as ge,hd as xe,h2 as W,bU as ve,a2 as ye,B as X,I as be,o as y,a as J,h as we,iJ as Se,iK as Te,iL as ke,ax as Ie,cl as Ae,cL as Ce}from"./index-BmW5CTHd.js";import{r as i}from"../vendor/vendor-emotion-D2wYcXAj.js";import{s as F,g as K}from"./index-DrXKLTvc.js";import{j as n}from"../vendor/vendor-motion-DRC1LdIk.js";import{P as Me}from"./PopoverGroup-CrEmGe1r.js";import{u as P,l as N}from"./index-DvYNxshK.js";import{m as je}from"./markdownToTxt-CEfvjtrd.js";import{c as _}from"./useOperationState-DAR6V060.js";import{da as Pe,b3 as Ne,aZ as q,bn as _e}from"../vendor/vendor-icons-Bjz-9Gdp.js";import"./providerConfig-DdZ8yyMi.js";import{A as Ee}from"./Alert-kWnj0yg0.js";import{A as Q}from"./index-CjltaXqJ.js";import{u as Y}from"./MarketAuthProvider-C2ImwTi0.js";import{o as $e}from"./Modal-fsV2FBFZ.js";import{D as ze}from"./index-cfgNlZqR.js";import{p as V,P as ee}from"./router-BPq88WVl.js";import{M as He}from"./Modal-BuUwDCT9.js";const Le=i.memo(()=>{const{analytics:e}=oe(),t=i.useCallback(()=>{const l=F.currentSession(K()),r=l?.id,c=F.defaultSessions(K()),a=B.showRightPanel(R.getState()),h=ie.activeDisplayMessages(se());return{active_assistant:r==="inbox"?null:l?.meta?.title||null,has_chat_history:h.length>0,session_id:r||"inbox",sidebar_state:a?"expanded":"collapsed",visible_assistants_count:c.length}},[]);return i.useEffect(()=>{if(!e)return;const l=setTimeout(()=>{e.track({name:"main_page_view",properties:{...t(),spm:"main_page.interface.view"}})},1e3);return()=>clearTimeout(l)},[e,t]),null});Le.displayName="MainInterfaceTracker";const We=k(({css:e,cssVar:t})=>({arrow:e`
    opacity: 0;
  ...
  `,drawer:e`
    ...
    height: 100%;
    background: ${t.colorBgContainer};
  `})),Tt=i.memo(({children:e})=>{const[t,l,r,c]=J(d=>[N.showPortal(d),N.showPluginUI(d),N.showArtifactUI(d),V.showThread(d)]),[a,h]=R(d=>[B.portalWidth(d),d.updateSystemStatus]),[m,s]=i.useState(a);m!==a&&s(a);const{lg:o}=we(),u=(d,p)=>{if(!p)return;const x=typeof p.width=="string"?Number.parseInt(p.width):p.width;x&&(C(x,a)||(s(x),h({portalWidth:x})))};return n.jsx(ze,{className:G.drawer,defaultSize:{width:m},expand:t,expandable:!1,maxWidth:ke,mode:o?"fixed":"float",placement:"right",showHandleWhenCollapsed:!1,showHandleWideArea:!1,size:{height:"100%",width:a},classNames:{content:G.content},minWidth:r||l||c?Se:Te,onSizeChange:u,children:n.jsx(i.Activity,{mode:t?"visible":"hidden",name:"AgentPortal",children:e})})}),Ye=Ie`
  :has(.portal-artifact) {
    overflow: hidden;
