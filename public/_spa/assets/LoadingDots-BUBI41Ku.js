import{j as m,m as d}from"./index-BmW5CTHd.js";import{r as y}from"../vendor/vendor-emotion-D2wYcXAj.js";import{j as t}from"../vendor/vendor-motion-DRC1LdIk.js";const i=m(({css:e,cssVar:s})=>{const a="var(--loading-dots-size, 8px)",n="var(--loading-dots-color, var(--ant-color-primary))";return{container:e`
      display: flex;
      flex-direction: row;
      gap: 6px;
      align-items: center;
