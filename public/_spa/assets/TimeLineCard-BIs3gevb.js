import{j as t}from"../vendor/vendor-motion-siEo8VfX.js";import{k as G,F as s,bV as re,I as K,b4 as b,g0 as k,j as S,W as F,X as _,aT as ne,iQ as ie,iR as ae,dv as se,iS as $,iT as A,T as D,o as M,a9 as u,ac as w,n as Y,C as le,m as E,cP as ce}from"./index-C275yc7e.js";import{S as de}from"./SearchBar-B03_FcLd.js";import{r as l}from"../vendor/vendor-emotion-B6qZrIr4.js";import{l as pe,dd as me,de as ge,c4 as ue,bO as he}from"../vendor/vendor-icons-CwKawJ1k.js";import{EditorModal as xe}from"./index-BhUUyIs3.js";import{S as d}from"./index-DMKxTJGG.js";import{N as ye}from"./index-D7TA4XOS.js";import{R as fe,T as je}from"./ToggleRightPanelButton-CuShRRuw.js";import{M as we}from"./Markdown-DhgCm8T7.js";import{G as Q}from"./Grid-C06UCg1E.js";import{J as ve,Y as Ce}from"./index-CKzyhCAc.js";import{u as U}from"./useScrollParent-CE4IOsQ_.js";const Fe=l.memo(({searchValue:o,onSearch:e,sortValue:r,onSortChange:n,sortOptions:a})=>{const{t:c}=G("memory");return t.jsxs(s,{horizontal:!0,align:"center",gap:12,children:[t.jsx(de,{allowClear:!0,defaultValue:o,placeholder:c("filter.search"),prefix:t.jsx(pe,{size:16}),style:{flex:1},onSearch:i=>e(i),onInputChange:i=>{i||e(i)}}),a&&a.length>0&&n&&t.jsx(re,{options:a,prefix:t.jsx(K,{icon:me,style:{marginRight:4}}),style:{minWidth:150},value:r,onChange:i=>n(i)})]})}),_e=l.memo(()=>{const o=b(i=>i.editingMemoryId),e=b(i=>i.editingMemoryContent),r=b(i=>i.editingMemoryLayer),n=b(i=>i.clearEditingMemory),a=b(i=>i.updateMemory),c={activity:k.Activity,context:k.Context,experience:k.Experience,identity:k.Identity,preference:k.Preference};return t.jsx(xe,{open:!!o,value:e,onCancel:n,onConfirm:async i=>{!o||!r||await a(o,i,c[r])}})}),be=S(({css:o,cssVar:e})=>({card:o`
  ...
  `,timelineLine_dark:o`
    background: ${e.colorFillQuaternary};
  `})),I=(o,e)=>e?e(o):o.capturedAt??o.createdAt??new Date;function Te({data:o,groupBy:e="day",getDateForGrouping:r,hasMore:n,isLoading:a,onLoadMore:c,renderHeader:i,renderItem:h}){const p=ce(),m=U(),{groupCounts:x,sortedPeriods:y,groupedItems:ee}=l.useMemo(()=>{const f=e==="month"?"YYYY-MM":"YYYY-MM-DD",j=o.reduce((g,v)=>{const z=I(v,r),C=w(z).format(f);return g[C]||(g[C]=[]),g[C].push(v),g},{}),T=Object.keys(j).sort((g,v)=>v.localeCompare(g)),L=[],R=[];for(const g of T){const z=[...j[g]].sort((W,C)=>{const te=I(W,r),oe=I(C,r);return w(oe).valueOf()-w(te).valueOf()});L.push(z.length),R.push(...z)}return{groupCounts:L,groupedItems:R,sortedPeriods:T}},[o,e,r]);return!o||o.length===0?null:t.jsxs("div",{className:B.timelineContainer,children:[t.jsx("div",{className:E(B.timelineLine,p&&B.timelineLine_dark)}),t.jsx(Ce,{customScrollParent:m,endReached:n&&c?c:void 0,groupCounts:x,increaseViewportBy:typeof window<"u"?window.innerHeight:0,overscan:24,style:{minHeight:"100%"},components:{Footer:a?()=>t.jsx(J,{viewMode:"timeline"}):void 0},groupContent:f=>{const j=y[f],T=x[f];return i(j,T)},itemContent:f=>{const j=ee[f];return h(j)}})]})}const Ue=l.memo(Te),P=S(({css:o,cssVar:e})=>({itemWrapper:o`
    position: relative;
  ...
  `})),Je=l.memo(({periodKey:o,groupBy:e="day"})=>{const r=e==="month"?w(`${o}-01`).format("MMMM YYYY"):w(o).format("MMMM D, YYYY");return t.jsx(s,{horizontal:!0,align:"center",className:P.periodHeader,gap:12,paddingBlock:8,children:t.jsx(u,{weight:500,children:r})})}),Xe=l.memo(({children:o})=>t.jsxs("div",{className:P.itemWrapper,children:[t.jsx("div",{className:P.timelineDot}),o]})),N="memory-actions",V=S(({css:o})=>({actions:o`
    transition: opacity 0.15s ease;
  `,timelineCard:o`
    position: relative;
    .${N} {
