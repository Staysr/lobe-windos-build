import{cc as M,j as S,n as b,m as k}from"./index-C275yc7e.js";import{A as x}from"./index-B1FRBCSR.js";import{G as q}from"./Grid-C06UCg1E.js";import{r as f}from"../vendor/vendor-emotion-B6qZrIr4.js";import{j as p}from"../vendor/vendor-motion-siEo8VfX.js";const z=(r,s=4)=>{const t=r/2,e=[];for(let o=0;o<=360;o+=2){const n=o*Math.PI/180,l=Math.cos(n),g=Math.sin(n),a=t*Math.sign(l)*Math.pow(Math.abs(l),2/s),m=t*Math.sign(g)*Math.pow(Math.abs(g),2/s);e.push(`${t+a},${t+m}`)}return`M${e[0]}L${e.slice(1).join("L")}Z`},d=(r={})=>{const{size:s=100,cornerValue:t=4}=r,e=`
