import{j as e}from"../vendor/vendor-motion-DRC1LdIk.js";import{r as n}from"../vendor/vendor-emotion-D2wYcXAj.js";import{u as ne,a as Te}from"./MarketAuthProvider-Cq4lbND_.js";import{u as J,s as Ue}from"./store-DzsL-yA2.js";import{N as Ne}from"./NotFound-CQ5LF0ge.js";import{k as T,B as de,F as r,a8 as w,C as Pe,j as R,r as ce,o as K,q as oe,a9 as F,W as X,gJ as Le,fF as De,a_ as Fe,f as q,aT as ie,$ as Ie,bD as Be,cP as D,aU as Ee,cQ as he,I as v,n as Y,cR as Z,cs as ge,m as pe,L as V,T as $,au as O,c2 as Ge,bt as Me,a6 as Re,cS as qe,bA as E,aG as Oe}from"./index-BBAuCJqA.js";import{A as _}from"./index-GNbd6Ibo.js";import{m as _e,aw as Qe,P as me,d9 as xe,aL as fe,bB as je,cu as ye,b8 as We,b9 as be,ab as ae,a4 as He,bx as Je,by as Xe,F as Ke,aZ as Ze}from"../vendor/vendor-icons-C6hg4LnF.js";import{G as ee}from"./Grid-2gpThKre.js";import{A as Ye}from"./AssistantEmpty-DPPoheiz.js";import{q as we}from"./base-AbuBx_QK.js";import{P as le}from"./PublishedTime-C7DA6p6K.js";import{a as M}from"./format-BRCSVQG4.js";import{P as te}from"./Pagination-CpmX6Kfs.js";import{M as Ve}from"./Modal-DupZSReQ.js";import{F as re}from"./index-DwHjYE4k.js";import{I as et}from"./index-BgqdOH23.js";import{S as ue}from"./index-BY_9ea5Y.js";import{L as tt}from"./ListLoading-BhHWkg_j.js";import"./index-BuH5qg8o.js";import"./row-ClDdlNJa.js";import"./index-D_OrzpAP.js";import"./index-Ds95mZpO.js";import"./useBubbleLock-BPwjL_yj.js";import"./events-NnJKY1rz.js";import"./providerConfig-DLbrlvJC.js";import"./Trans-D1YMwK4l.js";import"./index-PdJAJcSm.js";import"./EmojiPicker-dsRvQCWu.js";import"./useTranslation-8Gs39hO6.js";import"./emojiPicker-fXP8_c7a.js";import"./Tabs-DsI76Pz0.js";import"./index-BcDKp4gU.js";import"./index-BqAaZ8T3.js";import"../i18n/i18n-en-US-Dpq1-67h.js";import"./DeleteOutlined-DFutYCzo.js";import"./progress-DdbsdCjT.js";import"./index-Ciqn2WuZ.js";import"../i18n/i18n-zh-CN-CErfCpws.js";import"../vendor/vendor-es-toolkit-O0KSByiM.js";import"./index-C8CgY4-I.js";import"./index-D_NDLVtF.js";import"./Empty-BmpfRZff.js";import"./Drawer-hdkBrhHh.js";import"./useForm-BVlaNNzA.js";import"./index-C_IXsgL4.js";const ke=n.createContext(null),st=n.memo(({children:s,config:t})=>e.jsx(ke,{value:t,children:s})),I=()=>{const s=n.use(ke);if(!s)throw new Error("useUserDetailContext must be used within UserDetailProvider");return s},rt=n.memo(({userId:s})=>{const{t}=T("discover"),{isAuthenticated:u,signIn:o,session:m}=ne(),[h,f]=n.useState(!1),g=J(i=>i.useFollowStatus),p=J(i=>i.follow),l=J(i=>i.unfollow);m?.accessToken&&Ue.setAccessToken(m.accessToken);const{data:x,mutate:c}=g(s),d=x?.isFollowing??!1,y=async()=>{if(!u){await o();return}f(!0);try{d?await l(s):await p(s),await c()}catch(i){console.error("Follow action failed:",i)}finally{f(!1)}};return e.jsx(de,{loading:h,shape:"round",size:"large",type:d?"default":"primary",style:{fontWeight:500,minWidth:120},onClick:y,children:t(d?"user.unfollow":"user.follow")})}),nt=n.memo(()=>{const{t:s}=T("discover"),{user:t}=I(),u=t.followingCount??0,o=t.followersCount??0;return e.jsxs(r,{horizontal:!0,align:"center",gap:16,children:[e.jsxs(r,{horizontal:!0,align:"center",gap:8,children:[e.jsx(w,{style:{fontWeight:600},children:u}),e.jsx(w,{type:"secondary",children:s("user.following")})]}),e.jsxs(r,{horizontal:!0,align:"center",gap:8,children:[e.jsx(w,{style:{fontWeight:600},children:o}),e.jsx(w,{type:"secondary",children:s("user.followers")})]})]})}),H=R(({css:s,cssVar:t})=>({banner:s`
    position: absolute;
    inset-block-start: 0;
  ...
  `})),ve=n.memo(({avatar:s,bannerUrl:t})=>{const u=t||s,o=!t&&!!s;return e.jsxs(e.Fragment,{children:[e.jsx("div",{className:H.banner,children:e.jsx(Pe,{className:H.bannerInner,children:u&&e.jsx("div",{className:o?H.bannerAvatar:void 0,style:{backgroundImage:`url(${u})`,backgroundPosition:"center",backgroundSize:"cover",height:"100%",width:"100%"}})})}),e.jsx("div",{className:H.placeholder})]})}),ot=n.memo(()=>{const{t:s}=T("discover"),{user:t,isOwner:u,onEditProfile:o}=I(),m=t.displayName||t.userName||t.namespace,h=t.userName||t.namespace,f=n.useMemo(()=>{if(t.avatarUrl)return t.avatarUrl.startsWith("/")?`${window.location.origin}${t.avatarUrl}`:t.avatarUrl},[t.avatarUrl]),g=n.useMemo(()=>t.bannerUrl?t.bannerUrl.startsWith("/")?`${window.location.origin}${t.bannerUrl}`:t.bannerUrl:null,[t.bannerUrl]);return e.jsxs(e.Fragment,{children:[e.jsx(ve,{avatar:f,bannerUrl:g}),e.jsxs(r,{gap:16,children:[e.jsx(_,{avatar:f,shape:"square",size:64,style:{boxShadow:`0 0 0 4px ${K.colorBgContainer}`,flexShrink:0}}),e.jsxs(r,{horizontal:!0,align:"flex-start",gap:16,justify:"space-between",children:[e.jsxs(r,{gap:4,style:{overflow:"hidden"},children:[e.jsx(w,{ellipsis:!0,as:"h1",fontSize:24,style:{margin:0},weight:"bold",children:m}),e.jsxs(w,{ellipsis:!0,fontSize:12,type:"secondary",children:["@",h]})]}),u?o&&e.jsx(de,{shape:"round",onClick:()=>o(),children:s("user.editProfile")}):e.jsx(rt,{userId:t.id})]}),e.jsx(nt,{}),t.description&&e.jsx(w,{as:"p",children:t.description}),e.jsx(oe,{children:e.jsxs(r,{horizontal:!0,align:"center",gap:8,children:[t.socialLinks?.github&&e.jsx(F,{title:`@${t.socialLinks?.github}`,children:e.jsx("a",{href:`https://github.com/${t?.socialLinks?.github}`,rel:"noopener noreferrer",target:"_blank",children:e.jsx(X,{icon:e.jsx(Le,{size:16}),size:20,variant:"outlined"})})}),t.socialLinks?.twitter&&e.jsx(F,{title:`@${t.socialLinks?.twitter}`,children:e.jsx("a",{href:`https://twitter.com/${t?.socialLinks?.twitter}`,rel:"noopener noreferrer",target:"_blank",children:e.jsx(X,{icon:e.jsx(De,{size:16}),size:20,variant:"outlined"})})}),t.socialLinks?.website&&e.jsx(F,{title:t.socialLinks?.website,children:e.jsx("a",{href:t?.socialLinks?.website,rel:"noopener noreferrer",target:"_blank",children:e.jsx(X,{icon:_e,size:20,variant:"outlined"})})})]})})]})]})}),Ce=n.memo(({value:s,onChange:t})=>{const{t:u}=T("discover"),o=[{label:u("user.statusFilter.published"),value:"published"},{label:u("user.statusFilter.unpublished"),value:"unpublished"},{label:u("user.statusFilter.deprecated"),value:"deprecated"},{label:u("user.statusFilter.archived"),value:"archived"},{label:u("user.statusFilter.forked"),value:"forked"},{label:u("user.statusFilter.favorite"),value:"favorite"}];return e.jsx(Fe,{options:o,style:{minWidth:120},value:s,onChange:t})}),it=s=>{switch(s){case"published":return"green";case"unpublished":return"orange";case"deprecated":return"red";case"archived":return"default";default:return"default"}},P=R(({css:s,cssVar:t})=>({author:s`
